...
const commentApiAddr = () => (`https://cors.source.alist.sysdd.top/https://api.dandanplay.net/api/v2/comment`)
const searchApiAddr = () => (`https://cors.source.alist.sysdd.top/https://api.dandanplay.net/api/v2/search/episodes?`)
